...
public class Result_list1 extends AppCompatActivity {
        ...
        mylist1.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Toast.makeText(Result_list1.this, "value: " + value, Toast.LENGTH_SHORT).show();

                        Intent intent = new Intent(getApplicationContext(), RemoveResult.class);
                        ...
                        Result_list1.this.startActivity(intent);
